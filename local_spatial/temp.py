...
for modality_keys in modality_keys_list:
    ...
    best_model.save_model(f'./XGB_model/{combined_modality_key}_{model_used}_model.json')
    print(f"Model saved to ./XGB_model/{combined_modality_key}_{model_used}_model.json")
    ...
    plt.savefig(f'./XGB_model/features_importance/{combined_modality_key}_feature_importances.png')
    print(f"Feature importance plot saved as './XGB_model/features_importance/{combined_modality_key}_feature_importances.png'")
