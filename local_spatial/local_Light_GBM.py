...
def make_csv(y_pred_validation, modality_used):
    ...
    filename = f"../local_predictons/Light_GBM/{modality_used}_Light_GBM.csv"
...
best_model.booster_.save_model(f'./GBM_model/{modality_key}_lightgbm_model.txt')
print(f"Model saved to ./GBM_model/{modality_key}_lightgbm_model.txt")
...
# plt.tight_layout()
# plt.savefig(f'{modality_key}_feature_importances.png')
